...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_MULTIBOOT=1 -DGRUB_MACHINE=I386_MULTIBOOT -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/5/include -I$(top_srcdir)/include -I$(top_builddir)/include'
