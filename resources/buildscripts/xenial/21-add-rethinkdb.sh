...
if [ -d /lib/x86_64-linux-gnu ]; then
  wget http://files.sllabs.com/files/long-term/downloads/packages/rethinkdb_2.3.5-0xenial_amd64.deb
elif [ -d /lib/i386-linux-gnu ]; then
  wget http://files.sllabs.com/files/long-term/downloads/packages/rethinkdb_2.3.5-0xenial_i386.deb
fi
