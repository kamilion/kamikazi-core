...
cp -f /home/ubuntu/git/kamikazi-core/buildscripts/bionic/isomods/* /home/kamikazi-18.04/ISO/isolinux/
echo "KAMIKAZI-REBUILD: Removing WUBI from ISO..."
rm -f /home/kamikazi-18.04/ISO/wubi.exe
rm -f /home/kamikazi-18.04/ISO/autorun.inf
rm -Rf /home/kamikazi-18.04/ISO/pics/
echo "KAMIKAZI-REBUILD: Removing package pool from ISO..."
rm -Rf /home/kamikazi-18.04/ISO/dists/
rm -Rf /home/kamikazi-18.04/ISO/pool/
echo "KAMIKAZI-REBUILD: Clearing annoyances from filesystem..."
rm -Rf /home/kamikazi-18.04/FileSystem/var/cache/apt/archives
mkdir -p /home/kamikazi-18.04/FileSystem/var/cache/apt/archives/partial
echo "KAMIKAZI-REBUILD: Clearing apport crash reports from filesystem..."
rm -f /home/kamikazi-18.04/FileSystem/var/crash/*
