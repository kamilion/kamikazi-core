...
# V0.8.0 Runs this script third during a deploy to deal with Volatile USB Storage.
...
if [ -d /isodevice ]; then
    ...
    if [ ! -f /home/ubuntu/Desktop/root-terminal.desktop ]; then
        cp ${KCRES}/mods/etc/skel/Desktop/root-terminal.desktop /home/ubuntu/Desktop/
    ...
    if [ ! -f /home/ubuntu/Desktop/disker-terminal.desktop ]; then
        cp ${KCRES}/mods/etc/skel/Desktop/disker-terminal.desktop /home/ubuntu/Desktop/
    ...
    if [ ! -d /home/ubuntu/.x2goclient ]; then  ## x2go has no profile yet.
        cp -a ${KCRES}/mods/etc/skel/.x2goclient /etc/skel/
        cp -a ${KCRES}/mods/etc/skel/.PyCharm30 /etc/skel/
        cp -a ${KCRES}/mods/etc/skel/.x2goclient /home/ubuntu/
        cp -a ${KCRES}/mods/etc/skel/.PyCharm30 /home/ubuntu/
    ...
    if [ ! -d /home/ubuntu/.config/chromium ]; then  ## Chromium's profile doesn't exist yet.
        cp -a ${KCRES}/mods/etc/skel/.config /etc/skel/
        cp -a ${KCRES}/mods/etc/skel/.gconf /etc/skel/
        cp -a ${KCRES}/mods/etc/skel/.config /home/ubuntu/
        cp -a ${KCRES}/mods/etc/skel/.gconf /home/ubuntu/
    ...
    if [ ! -f /etc/rsyslog.d/35-disks.conf ]; then  ## Not baked in yet
        cp -a ${KCRES}/mods/etc/rsyslog.d/35-disks.conf /etc/rsyslog.d/
